#!/usr/bin/env python3
"""
Example Usage - PTDP Protection System
Demonstrasi lengkap cara menggunakan PTDP system
"""
...
def main():
    ...
    print("\n")
    print("╔" + "="*58 + "╗")
    print("║" + " "*10 + "PTDP PROTECTION SYSTEM EXAMPLES" + " "*17 + "║")
    print("╚" + "="*58 + "╝")
