# gui/viewer.py
"""
PTDP Viewer - End-User Application
GUI untuk membuka dan view protected .ptdp files
"""
...
class PTDPViewer:
    def __init__(self, root):
        self.root = root
        self.root.title("PTDP Viewer - Protected Digital Product")
    ...
    def setup_ui(self):
        ...
        welcome_msg = """
╔═══════════════════════════════════════════════════════════════╗
║                    Welcome to PTDP Viewer!                    ║
╚═══════════════════════════════════════════════════════════════╝

👋 This application helps you open protected digital products (.ptdp files)

📖 How to use:
   1. Click "Open PTDP File" button above
   2. Select your .ptdp file
...
Need help? Click the "Help" button above or contact the seller.
    ...
    def open_file_dialog(self):
        """Open file dialog untuk select .ptdp file"""
        file_path = filedialog.askopenfilename(
            title="Select PTDP File",
    ...
    def open_file(self, file_path):
        """Open dan display info .ptdp file"""
...
⚠️  Note: Invalid license keys will be rejected
    ...
    def unlock_file(self):
        ...
        if not self.current_file:
            messagebox.showwarning("No File", "Please open a PTDP file first")
            return
...
ℹ️  Note: The file will be automatically deleted when you close it.
    ...
    def show_help(self):
        """Show help dialog"""
        help_text = """
🔒 PTDP Viewer - Help Guide

WHAT IS PTDP?
PTDP (Protected Digital Product) is a secure file format for
protecting digital products like ebooks, courses, software, etc.

HOW TO OPEN A .PTDP FILE:
1. Click "Open PTDP File" button
2. Select your .ptdp file
...
© 2024 PTDP Protection System
        ...
        help_window.title("Help - PTDP Viewer")
