...
├── register_ptpd.bat       # Registry file association
...
Output:
- `dist/PTPD-Viewer.exe` - Untuk end-users
- `dist/PTPD-Creator.exe` - Untuk admin/seller

### Create Installer (Windows)

1. Install [Inno Setup](https://jrsoftware.org/isdl.php)
2. Run: `iscc installer.iss`
3. Output: `installer/PTPD-Viewer-Setup.exe`
...
### How to Open .ptpd Files

1. Download & install PTPD Viewer
2. Double-click any `.ptpd` file
3. Enter your license key
4. File will open in default app

### Get Your Device ID

Open PTPD Viewer, device ID shown at bottom.
...
2. **Upload to Distribution**
   - Upload `.ptpd` file to Google Drive/website
...
4. **Send License to Buyer**
   ...
   - Buyer enters it in PTPD Viewer
