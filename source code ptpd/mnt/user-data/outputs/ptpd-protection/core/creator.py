...
class PTPDCreator:
    ...
    def create_protected_file(self, input_file, output_file, protection_config):
        ...
        Args:
            ...
            output_file: Path output .ptpd file
    ...
    def batch_protect(self, input_files, output_dir, config_template):
        ...
        for i, input_file in enumerate(input_files, 1):
            ...
            # Output filename
            output_file = os.path.join(output_dir, base_name + '.ptpd')
...
def create_protected_cli():
    ...
    print("🔒 PTPD File Protection Tool")
    print("=" * 50)
    ...
    # Output file
    default_output = os.path.splitext(input_file)[0] + '.ptpd'
