# gui/creator.py
"""
PTPD Creator - Admin/Seller Tool
GUI untuk membuat protected .ptpd files
"""
...
class PTPDCreatorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("PTPD Creator - Protect Your Digital Products")
        self.root.geometry("700x800")
        self.root.configure(bg='#2b2b2b')
        
        self.creator = PTPDCreator()
    ...
    def create_protected(self):
        ...
        output_file = os.path.splitext(input_file)[0] + '.ptpd'
        
        # Ask for output location
        output_file = filedialog.asksaveasfilename(
            title="Save Protected File As",
            defaultextension=".ptpd",
            initialfile=os.path.basename(output_file),
            filetypes=[("PTPD Files", "*.ptpd")]
        )
