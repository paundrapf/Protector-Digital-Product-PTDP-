# PTDP Protection - Quick Start Guide

Get started with PTDP in 5 minutes!
...
1. Upload `.ptdp` file to Google Drive / your website
2. Send download link + license key to buyer
3. Buyer downloads PTDP Viewer and opens the file
...
### Step 1: Get PTDP Viewer

Download `PTDP-Viewer.exe` from the seller

### Step 2: Open Protected File

1. Run `PTDP-Viewer.exe`
2. Click "Open PTDP File"
...
Open PTDP Viewer - it's shown at the bottom. Send this to seller if you need a device-locked license.
...
Creates:
- `dist/PTDP-Viewer.exe` → Give to users
- `dist/PTDP-Creator.exe` → Keep for yourself
